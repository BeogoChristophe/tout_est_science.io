...
<main>
  <nav class="navbar navbar-dark " style="background-color: blue;" aria-label="Dark offcanvas navbar">
    <div class="container-fluid">
    <a class="navbar-brand" href="index1.php" style="font-size:30px;" ><img src="T_E_S.png" alt="logo"  width="8%" height="8%" style="border-radius:80px; top:20px; float: left;">Tout_Est_Science</a></a>
    <?php if(isset($_SESSION["auth"])):?>
    <a class="navbar-brand" style="color:#fff; z-index: 2;" href="se_deconnecter.php">Sign out</a>
    <?php else: ?>
    <a class="navbar-brand" style="color:#fff; z-index: 2;" href="s_enregister.php">Sign up</a>
    <a class="navbar-brand" style="color:#fff; z-index: 2;" href="se_connecter.php">Sign in</a>
    <?php endif ?>
      ...
      <div class="offcanvas offcanvas-end text-bg" style="background-color: blue;" tabindex="-1" id="offcanvasNavbarDark" aria-labelledby="offcanvasNavbarDarkLabel">
        ...
        <div class="offcanvas-body">
          <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
            ...
            <?php else: ?>
            <li><a class="dropdown-item " style="color: #fff;" href="s_enregister.php">Sign up</a></li>
            <li><a class="dropdown-item " style="color: #fff;" href="se_connecter.php" >Sign in</a></li>
            <?php endif ?>
              </ul>
            </li>
          </ul>
